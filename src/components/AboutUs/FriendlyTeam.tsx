...
export const FriendlyTeamSection = () => {
  return (
    <>
      <div className="flex ">
            ...
            <div className="flex items-end flex-wrap  px-5 lg:px-0">
              <div className="w-full lg:w-1/2 flex-1 flex flex-col gap-8">
                <div className="flex items-center gap-5 text-[#A9AFC3]">
                  <div className="w-[60px] h-[1px] bg-[#A9AFC3] uppercase "></div>
                  Our experts
                </div>
                <div className="flex flex-col gap-8">
                  ...
                  <div className="w-full">
                    <span className="md:text-[18px]  text-[#A9AFC3]">
                      Every day we communicate with each other, solve our
                      clients’ problems and work hard to succeed their business.
                    </span>
                  </div>
                </div>
              </div>
